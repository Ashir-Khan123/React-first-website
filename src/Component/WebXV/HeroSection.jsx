...
const HeroSection = () => {
  return (
    <div className="grid grid-cols-12 bg-[#0B0E12] text-white h-screen lg:text-start text-center">
      <div className="lg:col-span-6 col-span-12 flex flex-col lg:gap-11 gap-2 min-[1030px]:px-32 md:px-20 px-5 py-15">
        <div>
      ...
      <div className="lg:col-span-6 col-span-12 flex justify-center items-center pb-8">
        <div className="w-full sm:max-w-[400px] max-w-[300px] bg-[#0E151B] flex flex-col lg:gap-6 gap-4 px-6 lg:py-6 py-4 rounded-2xl">
