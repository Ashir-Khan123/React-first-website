      ...
      <div className='bg-[#0E151B] w-[60%] rounded-2xl'>
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='flex items-center gap-1.5'>
            <div className='text-[#FFFFFF]'>$42,122.00</div><div className='text-[#EA3943]'>-2.93%</div><div><img src={redSmall} alt="" /></div>
          </div>  
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='flex items-center gap-1.5'>
            <div className='text-[#FFFFFF]'>$2,214.77</div><div className='text-[#EA3943]'>-2.22%</div><div><img src={redSmall} alt="" /></div>
          </div>  
          <div className='w-[70px]'>
            <img src={blueImage} alt="" />
          </div>
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='flex items-center gap-1.5'>
            <div className='text-[#FFFFFF]'>$0.9999</div><div className='text-[#335DD2]'>0.04%</div><div><img src={blueSmall} alt="" /></div>
          </div>  
          <div className='w-[70px]'>
            <img src={blueImage} alt="" />
          </div>
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='flex items-center gap-1.5'>
            <div className='text-[#FFFFFF]'>$107.41</div><div className='text-[#EA3943]'>-11.20%</div><div><img src={redSmall} alt="" /></div>
          </div>  
          <div className='w-[70px]'>
            <img src={blueImage} alt="" />
          </div>
        ...
        <div className='flex items-center gap-2'>
            <div className='w-[23px]'>
              <img src={chartImageFive} alt="" className='bg-white rounded-2xl'/>
            </div>
            <div>
              <div>
                <p>XRP</p>
          ...
          <div className='flex items-center gap-1.5'>
            <div className='text-[#FFFFFF]'>$0.6183</div><div className='text-[#EA3943]'>-3.09%</div><div><img src={redSmall} alt="" /></div>
          </div>  
          <div className='w-[70px]'>
            <img src={blueImage} alt="" />
          </div>
